...
final class SwiftDataTestService {
    ...
    func testDeltaSyncParameters() {
        ...
        let userParams = swiftDataManager.getDeltaSyncParameters(for: "users")
        let listParams = swiftDataManager.getDeltaSyncParameters(for: "lists")
        let itemParams = swiftDataManager.getDeltaSyncParameters(for: "items")
        ...
        let now = Date()
        swiftDataManager.updateLastSyncTimestamp(for: "users", timestamp: now, since: "2024-01-01T00:00:00Z")
        swiftDataManager.updateLastSyncTimestamp(for: "lists", timestamp: now, since: "2024-01-01T00:00:00Z")
        swiftDataManager.updateLastSyncTimestamp(for: "items", timestamp: now, since: "2024-01-01T00:00:00Z")
        
        print("✅ SwiftDataTestService: Sync timestamps updated")
        
        // Test getting updated parameters
        let updatedUserParams = swiftDataManager.getDeltaSyncParameters(for: "users")
