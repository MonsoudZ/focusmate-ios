...
enum API {
  ...
  static func path(_ p: String) -> URL {
    ...
    return self.base.appendingPathComponent(normalized)
  }
  ...
  enum Lists {
    ...
    static func tasks(_ listId: String) -> String {
      "api/v1/lists/\(listId)/tasks"
    }

    static func task(_ listId: String, _ taskId: String) -> String {
    ...
    static func tasksReorder(_ listId: String) -> String {
      "api/v1/lists/\(listId)/tasks/reorder"
    }

    static func memberships(_ listId: String) -> String {
      "api/v1/lists/\(listId)/memberships"
    }
    ...
    static func membership(
      ...
      "api/v1/lists/\(listId)/memberships/\(membershipId)"
    }
    ...
    static func invites(_ listId: String) -> String {
      "api/v1/lists/\(listId)/invites"
    }

    static func invite(_ listId: String, _ inviteId: String) -> String {
      "api/v1/lists/\(listId)/invites/\(inviteId)"
    }
  }

  enum Invites {
    static func preview(_ code: String) -> String {
      "api/v1/invites/\(code)"
    }

    static func accept(_ code: String) -> String {
  ...
  enum Friends {
    ...
    static func friend(_ id: String) -> String {
      "api/v1/friends/\(id)"
    }
  }
}
