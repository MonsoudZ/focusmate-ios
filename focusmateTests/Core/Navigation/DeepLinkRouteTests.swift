...
final class DeepLinkRouteTests: XCTestCase {
  ...
  func testParseTaskNotificationWithLargeId() {
    ...
    XCTAssertEqual(route, .openTask(taskId: 999_999))
  }
  ...
  func testParseInviteURLWithCustomScheme() throws {
    let url = try XCTUnwrap(URL(string: "focusmate://invite/ABC123"))
  ...
  func testParseInviteURLWithHttpsScheme() throws {
    let url = try XCTUnwrap(URL(string: "https://focusmate.app/invite/XYZ789"))
  ...
  func testParseInviteURLWithHttpScheme() throws {
    let url = try XCTUnwrap(URL(string: "http://focusmate.app/invite/CODE456"))
  ...
  func testParseInviteURLWithLongCode() throws {
    let url = try XCTUnwrap(URL(string: "focusmate://invite/ABCDEFGHIJKLMNOP123456"))
  ...
  func testParseTaskURLWithCustomScheme() throws {
    let url = try XCTUnwrap(URL(string: "focusmate://task/42"))
  ...
  func testParseTaskURLWithHttpsScheme() throws {
    let url = try XCTUnwrap(URL(string: "https://focusmate.app/task/99"))
  ...
  func testParseTaskURLWithLargeId() throws {
    let url = try XCTUnwrap(URL(string: "focusmate://task/999999"))
  ...
  func testParseTaskURLWithNonNumericIdReturnsNil() throws {
    let url = try XCTUnwrap(URL(string: "focusmate://task/abc"))
  ...
  func testParseURLWithoutInvitePathReturnsNil() throws {
    let url = try XCTUnwrap(URL(string: "focusmate://home"))
  ...
  func testParseInviteURLWithoutCodeReturnsNil() throws {
    let url = try XCTUnwrap(URL(string: "focusmate://invite/"))
  ...
  func testParseURLWithDifferentPathReturnsNil() throws {
    let url = try XCTUnwrap(URL(string: "focusmate://settings/notifications"))
